...
fig0, ax0 = plt.subplots(4,1, figsize=(10, 15), constrained_layout=True)
mid_point_index = int(x_displacement.shape[1] / 2)
t_space = np.linspace(0, T, num=x_displacement.shape[0])
ax0[0].plot(t_space, u_eval[:,-1], label="tip")
ax0[0].plot(t_space, u_eval[:,mid_point_index], label="mid")
ax0[0].legend()
ax0[0].set_title("Axial displacements of the beam")
ax0[0].set_xlabel(r"time $t$")
ax0[0].set_ylabel(r"distance $u$")
ax0[1].plot(t_space, v_eval[:,-1], label="tip")
ax0[1].plot(t_space, v_eval[:,mid_point_index], label="mid")
ax0[1].legend()
ax0[1].set_title("Transverse displacements of the beam")
ax0[1].set_xlabel(r"time $t$")
ax0[1].set_ylabel(r"distance $v$")
ax0[2].plot(t_space, theta_sol)
ax0[2].set_title("Rotation of the beam")
ax0[2].set_xlabel(r"time $t$")
ax0[2].set_ylabel(r"angle $\theta$")
ax0[3].plot(t_space, [tau(t_i) for t_i in t_space])
ax0[3].set_title("Supplied torque from actuator")
ax0[3].set_xlabel(r"time $t$")
ax0[3].set_ylabel(r"torque $\tau$")
# fig0.suptitle("")
fig0.savefig("elastic_beam/out/displacement.png")
...
ani.save("elastic_beam/out/displacement.gif")
